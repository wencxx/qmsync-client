...
export function RegisterForm({
    ...
    const allowedEmails: Record<string, string[]> = {
        Faculty: ['2224702@slu.edu.ph', '2222657@slu.edu.ph', 'cefaculty1@slu.edu.ph',
            'cefaculty2@slu.edu.ph',
            'cefaculty3@slu.edu.ph',
            'cefaculty4@slu.edu.ph',
            'cefaculty5@slu.edu.ph',
            'cefaculty6@slu.edu.ph',
            'cefaculty7@slu.edu.ph',
            'cefaculty8@slu.edu.ph',
            'cefaculty9@slu.edu.ph',
            'cefaculty10@slu.edu.ph',
            'cefaculty11@slu.edu.ph',
            'cefaculty12@slu.edu.ph',
            'cefaculty13@slu.edu.ph',
            'cefaculty14@slu.edu.ph',
            'cefaculty15@slu.edu.ph',
            'cefaculty16@slu.edu.ph',
            'cefaculty17@slu.edu.ph',
            'cefaculty18@slu.edu.ph',
            'cefaculty19@slu.edu.ph',
            'cefaculty20@slu.edu.ph',
            'cefaculty21@slu.edu.ph'
        ],
